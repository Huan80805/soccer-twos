...
ALGORITHM = "PPO"
CHECKPOINT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "checkpoint", "checkpoint-1200")
...
class BaselinePPOAgent(AgentInterface):
    """
    PPO agent trained on team_vs_policy and packaged for evaluation/submission.
    """
    ...
    def __init__(self, env):
        ...
        # Keep evaluation local and deterministic. The checkpoint was trained on a
        # concatenated team observation, so the dummy env must expose team spaces.
